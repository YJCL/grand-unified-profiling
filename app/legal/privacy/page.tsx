...
export const metadata = { title: 'プライバシーポリシー | Grand Unified Fortune' };
      ...
      <div className="max-w-2xl mx-auto px-6 py-14">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-white/75 font-serif-jp">
          ...
          <section>
            ...
            <p>通信はTLSにより暗号化されます。パスワードはソルト付きの一方向ハッシュ（scrypt）で保存され、運営者を含め何人も元のパスワードを復元できません。</p>
          </section>
