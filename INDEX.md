...
| `ROADMAP.md` | 更新 | 収益化ロードマップ・単一ソース。¥550→¥3,000に統一、ココナラ外部チャネルの実データを反映 |
...
1. **Orba本体の月額価格**：¥550(ROADMAP/旧BRIEF) / ¥500(RELEASE) / ¥500・¥2000(HANDOFF_FORTUNE_PARTNER) / ¥3,000(このチャット＋新2文書)
   → **¥3,000/月想定に統一**（少数高単価モデルへの転換を反映）
...
5. **決済前提**：Stripe前提のまま(RELEASE) → 既に停止済み。ococala／ココナラ定期購入などが候補（未確定）である旨を明記

---

## 未解決のまま（次に詰めるべきこと）

- Orba本体¥3,000/月の決済レール（ococala／ココナラ定期購入／その他）は未確定
